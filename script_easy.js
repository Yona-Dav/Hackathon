let words = ['great','house','paper','computer','window','mouse','clothes', 'stomach', 'tonight','summer','photograph'];
let line = "";
...
let newText = document.createTextNode(`Guesses Remaining : 10`);
...
function numLifes(){
    ...
    if (count === 9){
        let basisBottom = document.createElement('div');
        basisBottom.setAttribute('id', 'basisBottom');
        basisBottom.classList.add('hangman');
        drawSide.appendChild(basisBottom);
    }else if (count ===8){
        let basisLeft = document.createElement('div');
        basisLeft.setAttribute('id', 'basisLeft');
        basisLeft.classList.add('hangman');
        drawSide.appendChild(basisLeft);
    }else if (count ===7){
        let basisTop = document.createElement('div');
        basisTop.setAttribute('id', 'basisTop');
        basisTop.classList.add('hangman');
        drawSide.appendChild(basisTop);
    }else if (count ===6){
        let rope = document.createElement('div');
        rope.setAttribute('id', 'rope');
        rope.classList.add('hangman');
        drawSide.appendChild(rope);
    }else if (count ===5){
